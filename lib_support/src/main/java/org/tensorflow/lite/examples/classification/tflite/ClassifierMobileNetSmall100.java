...
public class ClassifierMobileNetSmall100 extends Classifier {
   ...
   * @param activity
   */
  public ClassifierMobileNetSmall100(Activity activity, Device device, int numThreads)
      throws IOException {
  ...
  protected String getModelPath() {
    ...
    return "lite-model_imagenet_mobilenet_v3_small_100_224_classification_5_default_1.tflite";
